// Middleware function for to check customer authentication
...
const CustomerAuthentication = (req, res, next) => {
  ...
  if (!Token) return res.json({ message: "No permission to access this route without authentication", type: "error" });
